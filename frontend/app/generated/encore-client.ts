...
/**
 * Client is an API client for the robinshark Encore application.
 */
...
export interface ClientOptions {
     ...
     */
    auth?: api.AuthParams | AuthDataGenerator
}
...
export namespace api {
    ...
    export class ServiceClient {
        ...
        public async getArena(): Promise<ArenaResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/arena`)
            return await resp.json() as ArenaResponse
        }

        public async getOpenRouterIntegration(): Promise<OpenRouterIntegration> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/integrations/openrouter`)
...
export type AuthDataGenerator = () =>
  | api.AuthParams
  | Promise<api.AuthParams | undefined>
  | undefined;
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "robinshark-Generated-TS-Client (Encore/v1.57.11)";
        }
    ...
    async getAuthData(): Promise<CallParameters | undefined> {
        let authData: api.AuthParams | undefined;
