...
RobinArena is a live trading arena for six language models. OpenRouter routes
...
Robinhood account capital is divided equally across the six isolated model
...
4. Ask all six models concurrently for one structured long-only decision. An empty model ledger must request a 20-40% opening position.
